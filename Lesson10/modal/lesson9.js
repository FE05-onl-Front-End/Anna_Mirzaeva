...
let showHoverBlock = (e) => {
    let hoverBlock = document.getElementById('hover-block');
    let p = document.createElement('p');
    p.innerText = `${e.target.innerText}`;
    hoverBlock.append(p);
    hoverBlock.style.opacity = '1';
    replaceElementStyle(hoverBlock, "hover-block-hide", "hover-block");
}

let hideHoverBlock = (e) => {
    let hoverBlock = document.getElementById('hover-block');
    hoverBlock.removeChild(hoverBlock.firstChild);
    replaceElementStyle(hoverBlock, "hover-block", "hover-block-hide");
}

let replaceElementStyle = (element, oldStyle, newStyle) => {
